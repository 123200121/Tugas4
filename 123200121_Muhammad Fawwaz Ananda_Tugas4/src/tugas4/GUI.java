...
public class GUI extends JFrame{
    JLabel luname = new JLabel("Uname: ");
    JTextField funame = new JTextField (13);
    JLabel lpass = new JLabel("Password: ");
    JPasswordField fpass = new JPasswordField(13);
    JButton blogin = new JButton("LOGIN");
    JButton bcancel = new JButton("Cancel");
    JLabel lreguname = new JLabel ("Uname: ");
    JTextField freguname = new JTextField (13);
    JLabel lregpass = new JLabel("Password: ");
    JPasswordField fregpass = new JPasswordField(13);
